 ...
 // More initializers here.
{
  ...
  art::ServiceHandle<art::TFileService> tfs;
      ...
      fEventTree->Branch("NuEnergy", "std::vector<double>", &enu_truth);
      ...
      fEventTree->Branch("NuPx", "std::vector<double>", &nupx_truth);
      fEventTree->Branch("NuPy", "std::vector<double>", &nupy_truth);
      fEventTree->Branch("NuPz", "std::vector<double>", &nupz_truth);
